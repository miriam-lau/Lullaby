...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_animejs__ = __webpack_require__(3);
...
const songs = __webpack_require__(5);
...
class Display {
  ...
  showSong(value) {
    ...
    for (var i = 0; i < currentSong.length; i++) {
      ...
      // this.ctx.fillText(currentSong[i], ((window.innerWidth - 300) / 2), yPos);
