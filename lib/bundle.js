...
/* WEBPACK VAR INJECTION */(function($) {const songs = __webpack_require__(6);
...
class Display {
  ...
  showSong(value) {
    ...
    // let currentSongLyrics = songLyrics.get(value.value);
    ...
    for (var i = 0; i < currentSong.length; i++) {
      ...
      // for (var j = 0; j < currentSongLyrics[i].length; j++) {
      //   sentence += "<span class=\"song-word\">" + currentSongLyrics[i][j] + "</span>";
      // }
      // sentence += "</div>";
    }
...
sounds.set(85, ['./sounds/54_D5.wav']);
sounds.set(73, ['./sounds/56_E5.wav']);
sounds.set(79, ['./sounds/57_F5.wav']);
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_animejs__ = __webpack_require__(0);
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  animate = __WEBPACK_IMPORTED_MODULE_0_animejs___default()({
    duration: Infinity,
    update: function() {
...
function handleEvent() {
  ...
  for (let i = 0; i < 32; i++) {
    let particle = new Circle({
      ...
      r: __WEBPACK_IMPORTED_MODULE_0_animejs___default.a.random(1, 5)
    })
    particles.push(particle);
  }

  for (let i = 0; i < 3; i++) {
    let particlesAnimation = __WEBPACK_IMPORTED_MODULE_0_animejs___default()({
      targets: particles,
      x: function(particle){
        return particle.x + __WEBPACK_IMPORTED_MODULE_0_animejs___default.a.random(rippleSize, -rippleSize);
      },
      y: function(particle){
        return particle.y + __WEBPACK_IMPORTED_MODULE_0_animejs___default.a.random(rippleSize * 1.15, -rippleSize * 1.15);
      },
      r: 0,
      easing: "easeOutExpo",
      duration: __WEBPACK_IMPORTED_MODULE_0_animejs___default.a.random(1000,1300),
      speed: 0.5,
...
let resizeCanvas = function() {
  ...
  canvasEl.width = cW;
  canvasEl.height = cH;
  $('#song-display').css({'left': parseInt((window.innerWidth/ 2) - 150)});
  $('div.logo').css({'left': parseInt(window.innerWidth/ 2)});
  $('#instruction-display').css(
      {'left': parseInt((window.innerWidth/ 2) - 150)}
  );
};

function startFauxClicking() {
  setTimeout(function(){
    fauxClick(__WEBPACK_IMPORTED_MODULE_0_animejs___default.a.random( cW * .2, cW * .8), __WEBPACK_IMPORTED_MODULE_0_animejs___default.a.random(cH * .2, cH * .8));
    startFauxClicking();
  }, __WEBPACK_IMPORTED_MODULE_0_animejs___default.a.random(200, 900));
}
...
songs.set("6", ItsyBitsySpider);
songs.set("7", MaryHadALittleLamb);
songs.set("8", RockAByeBaby);
songs.set("9", RowRowRowYourBoat);
songs.set("10", SomewhereOverTheRainbow);
songs.set("11", TwinkleTwinkleLittleStar);
